...
# From https://nattdf.streamlit.app/
...
color_echo "green" "Done installing multimedia codecs"
...
color_echo "green" "Done installing ${dnf_apps[@]}"
...
for app_id in "${flatpak_apps[@]}"; do
    ...
    color_echo "green" "Done installing $app_id"
done
